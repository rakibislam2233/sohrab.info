  ...
  const article = {
    title:
      slug === "primary-education"
        ? "Transformation of Primary Education: A Journey to the Roots"
        : slug === "mango-farming"
          ? "Commercial Mango Farming Success in Northern Districts"
        ...
        <div className="absolute inset-0 flex flex-col justify-end container mx-auto px-4 pb-12">
          ...
          <Reveal delay={0.3}>
            <div className="flex flex-wrap items-center gap-6 text-white/70 text-sm">
              ...
              <span className="flex items-center gap-2">
                <Calendar size={16} className="text-gray-400" /> {article.date}
              </span>
            </div>
          </Reveal>
        </div>
