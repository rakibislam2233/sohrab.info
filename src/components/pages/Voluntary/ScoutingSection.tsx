...
const ScoutingSection = () => {
  return (
    <section className="flex justify-center px-4 md:px-10 py-24 bg-[#0D1424] border-y border-[#1E293B]">
      <div className="layout-content-container flex flex-col max-w-7xl w-full">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="flex flex-col gap-8 lg:w-1/3 lg:sticky lg:top-32">
            <div className="inline-flex items-center gap-2 rounded-lg bg-[#38bdf8]/10 border border-[#38bdf8]/20 px-3 py-1 text-xs font-bold text-[#38bdf8] uppercase tracking-wide w-fit">
            ...
            <div>
              <h2 className="text-primary text-3xl md:text-4xl font-bold leading-tight mb-4">
                A Lifetime of <br />
                <span className="text-[#38bdf8]">Scouting</span>
              </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-3 rounded-lg hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                <div className="h-10 w-10 rounded-full bg-[#131C2E] border border-[#1E293B] flex items-center justify-center text-[#38bdf8]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-2/3">
            <div className="group flex flex-col gap-4 p-5 rounded-2xl bg-[#131C2E] border border-[#1E293B] hover:border-[#38bdf8]/40 transition-all hover:shadow-lg hover:shadow-[#38bdf8]/5">
