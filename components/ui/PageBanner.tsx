...
export default function PageBanner({ 
  ...
  return (
    <section className={`relative w-full overflow-hidden flex items-center pt-28 sm:pt-40 pb-12 sm:pb-14 justify-center ${themeColor}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
        <Reveal>
          <h1 className={`text-2xl sm:text-3xl md:text-5xl font-bold ${textColor} uppercase tracking-tighter mb-4`}>
            {title}
          </h1>
        </Reveal>
      </div>
