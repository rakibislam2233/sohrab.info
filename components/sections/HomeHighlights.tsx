      ...
      <div className="container mx-auto px-6">
        <Reveal>
          <div className="max-w-2xl mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">What I Focus On</h2>
            ...
            <Reveal key={block.title} delay={index * 0.1}>
              <Link href={block.href} className="group block h-full">
                <div className={`h-full p-10 rounded-3xl transition-all duration-300 border border-transparent hover:border-gray-200 hover:shadow-xl hover:-translate-y-2 ${block.color}`}>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">{block.text}</p>
                  
                  <div className="flex items-center gap-2 text-sm font-bold group-hover:text-pink-600 transition-colors">
                    Explore More
