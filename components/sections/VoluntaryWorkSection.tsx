...
const works = [
  {
    ...
    description:
      "Organized and participated in a large-scale blanket distribution for the elderly and underprivileged people in Thakurgaon during the extreme cold.",
  ...
  },
  {
    ...
    description:
      "Actively involved in tree plantation campaigns across Thakurgaon district to promote ecological balance and sustainability.",
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <Reveal>
          <div className="max-w-xl mb-8">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-black mb-2 uppercase tracking-tighter">
              Voluntary Work
            </h2>
            <p className="text-sm text-gray-500 font-medium max-w-prose">
              Giving back to the community through environmental and
