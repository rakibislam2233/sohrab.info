...
const achievements = [
  {
    ...
    description:
      "Highest recognition from Bangladesh Scouts for outstanding voluntary service during the National Vitamin A plus campaign and pandemic relief.",
  ...
  },
  {
    ...
    description:
      "Recognized for exceptional leadership and coordination of the Thakurgaon Govt. College Rover Scout Group.",
  ...
  },
  {
    ...
    description:
      "Awarded for selfless dedication in awareness campaigns and relief distribution during the global pandemic.",
      ...
      <div className="container mx-auto px-6">
        <Reveal>
          <div className="max-w-xl mb-8">
            <h2 className="text-2xl md:text-4xl font-black text-black mb-2 uppercase tracking-tighter">
              Key Achievements
            </h2>
            <p className="text-sm text-gray-500 font-medium">
              Recognition for professional excellence in journalism and
              dedicated service in scouting.
            </p>
          </div>
        </Reveal>
