      ...
      <div className="container mx-auto px-4">
        <Reveal>
          <div className="flex flex-col items-center mb-16">
            <span className="text-black font-bold uppercase tracking-[0.2em] text-xs mb-4 border-b-2 border-black pb-1">
              Academic Journey
            </span>
          ...
          {educationData.map((edu, index) => (
            <Reveal key={index} delay={index * 0.1}>
              <div className="relative pl-8 pb-12 border-l-2 border-gray-200 last:pb-0 group">
                ...
                <div className="bg-white p-6 rounded shadow-none border border-gray-100 hover:border-black transition-all duration-300">
                  <div className="flex flex-wrap justify-between items-start gap-4 mb-4">
                    ...
                    <div className="flex flex-col items-end text-sm text-gray-500">
                      <span className="flex items-center gap-1 font-bold text-black bg-gray-100 px-3 py-1 rounded-sm">
                        <Calendar size={14} />
                        {edu.duration}
                      </span>
